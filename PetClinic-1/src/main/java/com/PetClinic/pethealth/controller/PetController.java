...
public class PetController {
	...
	public ResponseEntity<Scheduled> logVisit (@RequestParam String date, @RequestParam String time, 
		...
		Visit visit = new Visit(null, date, time, purpose, null, null);
		...
		Scheduled scheduled = new Scheduled(100, "Visit "+visit+" Scheduled Successfully");
		
		return new ResponseEntity<Scheduled>(scheduled, HttpStatus.OK);
		
		}catch(Exception exception) {
			Scheduled scheduled = new Scheduled(911, "Visit "+visit+" Not Scheduled Successfully. Exception: "+exception.getMessage());
